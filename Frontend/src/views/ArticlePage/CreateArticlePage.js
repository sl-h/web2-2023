...
import {createArticle} from "../../services/actions/articleActions"
...
const AddArticlePage = () => {
    ...
    const createArticleReducer = useSelector((state) => state.createArticleReducer);
    const userInfo = JSON.parse(localStorage.getItem('userInfo'))
    const { success, error } = createArticleReducer;
    ...
    return <MainPage tittle={"Add new article"}>
        <>
            {success ? (
                <section>
                    <h1>Success!</h1>
                    <Link to="/" style={{color:"blue"}}></Link>
                </section>
            ) : (
                    ...
                    </Form.Group>
                    {
                        userInfo.verified ? (
                            ...
                            <>
                                ...
                                <p className={'invalid'}>You are not verified yet</p>
                            </>
